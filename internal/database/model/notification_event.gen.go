...
const TableNameNotificationEvent = "notification_event"

// NotificationEvent mapped from table <notification_event>
...
// TableName NotificationEvent's table name
func (*NotificationEvent) TableName() string {
	return TableNameNotificationEvent
}
