...
const TableNameSalutation = "salutation"

// Salutation mapped from table <salutation>
...
// TableName Salutation's table name
func (*Salutation) TableName() string {
	return TableNameSalutation
}
