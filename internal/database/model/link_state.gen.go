...
const TableNameLinkState = "link_state"

// LinkState mapped from table <link_state>
...
// TableName LinkState's table name
func (*LinkState) TableName() string {
	return TableNameLinkState
}
