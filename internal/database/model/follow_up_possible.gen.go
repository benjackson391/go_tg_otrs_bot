...
const TableNameFollowUpPossible = "follow_up_possible"

// FollowUpPossible mapped from table <follow_up_possible>
...
// TableName FollowUpPossible's table name
func (*FollowUpPossible) TableName() string {
	return TableNameFollowUpPossible
}
