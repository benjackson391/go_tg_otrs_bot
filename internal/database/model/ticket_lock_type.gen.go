...
const TableNameTicketLockType = "ticket_lock_type"

// TicketLockType mapped from table <ticket_lock_type>
...
// TableName TicketLockType's table name
func (*TicketLockType) TableName() string {
	return TableNameTicketLockType
}
