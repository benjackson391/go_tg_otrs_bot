...
const TableNameTicketState = "ticket_state"

// TicketState mapped from table <ticket_state>
...
// TableName TicketState's table name
func (*TicketState) TableName() string {
	return TableNameTicketState
}
