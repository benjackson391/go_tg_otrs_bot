...
const TableNamePmTransition = "pm_transition"

// PmTransition mapped from table <pm_transition>
...
// TableName PmTransition's table name
func (*PmTransition) TableName() string {
	return TableNamePmTransition
}
