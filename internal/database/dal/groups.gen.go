...
func newGroup(db *gorm.DB, opts ...gen.DOOption) group {
	...
	_group.Comments = field.NewString(tableName, "comments")
	_group.ValidID = field.NewInt32(tableName, "valid_id")
	_group.CreateTime = field.NewTime(tableName, "create_time")
	_group.CreateBy = field.NewInt32(tableName, "create_by")
	_group.ChangeTime = field.NewTime(tableName, "change_time")
	_group.ChangeBy = field.NewInt32(tableName, "change_by")
