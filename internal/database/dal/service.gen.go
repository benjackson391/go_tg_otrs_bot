...
func newService(db *gorm.DB, opts ...gen.DOOption) service {
	...
	_service.ValidID = field.NewInt32(tableName, "valid_id")
	_service.Comments = field.NewString(tableName, "comments")
	_service.CreateTime = field.NewTime(tableName, "create_time")
	_service.CreateBy = field.NewInt32(tableName, "create_by")
	_service.ChangeTime = field.NewTime(tableName, "change_time")
	_service.ChangeBy = field.NewInt32(tableName, "change_by")
