...
func newGroupUser(db *gorm.DB, opts ...gen.DOOption) groupUser {
	...
	_groupUser.UserID = field.NewInt32(tableName, "user_id")
	_groupUser.GroupID = field.NewInt32(tableName, "group_id")
	_groupUser.PermissionKey = field.NewString(tableName, "permission_key")
	_groupUser.CreateTime = field.NewTime(tableName, "create_time")
	_groupUser.CreateBy = field.NewInt32(tableName, "create_by")
	_groupUser.ChangeTime = field.NewTime(tableName, "change_time")
	_groupUser.ChangeBy = field.NewInt32(tableName, "change_by")
