...
func newRole(db *gorm.DB, opts ...gen.DOOption) role {
	...
	_role.Comments = field.NewString(tableName, "comments")
	_role.ValidID = field.NewInt32(tableName, "valid_id")
	_role.CreateTime = field.NewTime(tableName, "create_time")
	_role.CreateBy = field.NewInt32(tableName, "create_by")
	_role.ChangeTime = field.NewTime(tableName, "change_time")
	_role.ChangeBy = field.NewInt32(tableName, "change_by")
...
func (r *role) updateTableName(table string) *role {
	...
	r.ValidID = field.NewInt32(table, "valid_id")
