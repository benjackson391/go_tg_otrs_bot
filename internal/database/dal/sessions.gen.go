...
func newSession(db *gorm.DB, opts ...gen.DOOption) session {
	...
	_session.DataKey = field.NewString(tableName, "data_key")
	_session.DataValue = field.NewString(tableName, "data_value")
	_session.Serialized = field.NewInt32(tableName, "serialized")
...
type session struct {
	...
	DataValue  field.String
	Serialized field.Int32
...
func (s *session) updateTableName(table string) *session {
	...
	s.Serialized = field.NewInt32(table, "serialized")
...
func (s *session) fillFieldMap() {
	...
	s.fieldMap["serialized"] = s.Serialized
}
