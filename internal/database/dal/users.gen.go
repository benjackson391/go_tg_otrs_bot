...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.Login = field.NewString(tableName, "login")
	_user.Pw = field.NewString(tableName, "pw")
	...
	_user.ValidID = field.NewInt32(tableName, "valid_id")
	_user.CreateTime = field.NewTime(tableName, "create_time")
	_user.CreateBy = field.NewInt32(tableName, "create_by")
	_user.ChangeTime = field.NewTime(tableName, "change_time")
	_user.ChangeBy = field.NewInt32(tableName, "change_by")
...
func (u *user) updateTableName(table string) *user {
	...
	u.Login = field.NewString(table, "login")
	u.Pw = field.NewString(table, "pw")
	...
	u.ValidID = field.NewInt32(table, "valid_id")
	u.CreateTime = field.NewTime(table, "create_time")
	u.CreateBy = field.NewInt32(table, "create_by")
	u.ChangeTime = field.NewTime(table, "change_time")
	u.ChangeBy = field.NewInt32(table, "change_by")
